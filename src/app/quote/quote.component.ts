...
export class QuoteComponent implements OnInit {
  ...
  // ]
  quotes: Quotes[] = [
    new Quotes("“to learn and not to do is really not to learn. To know and not to do is really not to know.”", "Bill Gates", "Joy K", 20, 50,new Date(2020,3,14)),
    new Quotes("“The Bible will always be full of things you cannot understand, as long as you will not live according to those you can understand.”", "Mora Savier", "Kirui Mart", 200, 44,new Date(2020,3,14)),
    new Quotes("“knowledge without application is like a book that is never read' Christopher Crawford, Hemel Hempstead.”", "Christopher Crawford", "Cindy Kip", 60, 44,new Date(2020,3,14)),
    new Quotes("“The Bible will always be full of things you cannot understand, as long as you will not live according to those you can understand.”", "Billy Sunday", "Ann Mariee", 602, 44,new Date(2020,3,14))
  ];
